 ...
 *
 */
package com.shashankmunda.musica.models
...
import com.shashankmunda.musica.playback.TimberMusicService.Companion.TYPE_SONG
import com.shashankmunda.musica.extensions.value
import com.shashankmunda.musica.extensions.valueOrDefault
import com.shashankmunda.musica.extensions.valueOrEmpty
...
data class Song(
    ...
    companion object {
        ...
        fun fromPlaylistMembersCursor(cursor: Cursor): Song {
            return Song(
                    id = cursor.value(Members.AUDIO_ID),
