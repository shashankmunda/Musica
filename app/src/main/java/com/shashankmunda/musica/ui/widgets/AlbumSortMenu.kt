 ...
 *
 */
package com.shashankmunda.musica.ui.widgets
...
class AlbumSortMenu constructor(context: Context, attrs: AttributeSet) : AppCompatImageView(context, attrs) {
        ...
        setOnClickListener {
            ...
            popupMenu.setOnMenuItemClickListener {
                when (it.itemId) {
                    ...
                    R.id.menu_sort_by_number_of_songs -> sortMenuListener?.numOfSongs()
                }
                true
            }
            popupMenu.inflate(R.menu.album_sort_by)
            popupMenu.show()
        }
    }
