 ...
 *
 */
package com.shashankmunda.musica.playback
...
import com.shashankmunda.musica.constants.Constants.ACTION_NEXT
import com.shashankmunda.musica.constants.Constants.ACTION_PREVIOUS
import com.shashankmunda.musica.constants.Constants.APP_PACKAGE_NAME
import com.shashankmunda.musica.db.QueueEntity
import com.shashankmunda.musica.db.QueueHelper
...
import com.shashankmunda.musica.extensions.toIDList
import com.shashankmunda.musica.extensions.toRawMediaItems
import com.shashankmunda.musica.models.MediaID
import com.shashankmunda.musica.models.MediaID.Companion.CALLER_OTHER
import com.shashankmunda.musica.models.MediaID.Companion.CALLER_SELF
import com.shashankmunda.musica.notifications.Notifications
import com.shashankmunda.musica.permissions.PermissionsManager
import com.shashankmunda.musica.playback.players.SongPlayer
import com.shashankmunda.musica.repository.AlbumRepository
import com.shashankmunda.musica.repository.ArtistRepository
import com.shashankmunda.musica.repository.GenreRepository
import com.shashankmunda.musica.repository.PlaylistRepository
import com.shashankmunda.musica.repository.SongsRepository
import com.shashankmunda.musica.util.Utils.EMPTY_ALBUM_ART_URI
...
class TimberMusicService : MediaBrowserServiceCompat(), KoinComponent, LifecycleOwner {
    ...
    override fun onCreate() {
        ...
        player.onPlayingState { isPlaying ->
            ...
            notifications.updateNotification(this@TimberMusicService.scope,player.getSession())
        }
