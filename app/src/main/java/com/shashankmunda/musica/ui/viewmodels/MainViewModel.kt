...
import com.shashankmunda.musica.cast.CastHelper
import com.shashankmunda.musica.cast.CastServer
import com.shashankmunda.musica.constants.Constants
import com.shashankmunda.musica.constants.Constants.ACTION_CAST_CONNECTED
import com.shashankmunda.musica.constants.Constants.ACTION_CAST_DISCONNECTED
import com.shashankmunda.musica.constants.Constants.ACTION_PLAY_NEXT
...
import com.shashankmunda.musica.extensions.id
import com.shashankmunda.musica.extensions.isPlayEnabled
import com.shashankmunda.musica.extensions.isPlaying
import com.shashankmunda.musica.extensions.isPrepared
import com.shashankmunda.musica.extensions.show
import com.shashankmunda.musica.models.CastStatus
import com.shashankmunda.musica.models.CastStatus.Companion.STATUS_NONE
import com.shashankmunda.musica.models.MediaID
import com.shashankmunda.musica.models.Song
import com.shashankmunda.musica.playback.MediaSessionConnection
...
import com.shashankmunda.musica.ui.dialogs.AddToPlaylistDialog
import com.shashankmunda.musica.ui.dialogs.DeleteSongDialog
import com.shashankmunda.musica.ui.listeners.PopupMenuListener
import com.shashankmunda.musica.util.Event
...
class MainViewModel(
    ...
    private val musicUtils: MusicUtils,
        ...
        override fun onStatusUpdated() {
            ...
            castSession?.let {
                _castLiveData.postValue(
                    CastStatus().fromRemoteMediaClient(it.castDevice.friendlyName,
    ...
    private fun startCastServer() {
        log("startCastServer()")
        castServer = CastServer(context,musicUtils)
        try {
            castServer?.start()
        } catch (e: IOException) {
            e.printStackTrace()
