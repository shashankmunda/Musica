 ...
 *
 */
package com.shashankmunda.musica.notifications
...
import com.shashankmunda.musica.playback.TimberMusicService
import com.shashankmunda.musica.constants.Constants.ACTION_NEXT
import com.shashankmunda.musica.constants.Constants.ACTION_PLAY_PAUSE
...
import com.shashankmunda.musica.util.Utils.isOreo
...
interface Notifications {
    ...
    fun updateNotification(scope: CoroutineScope, mediaSession: MediaSessionCompat)
...
class RealNotifications(
    ...
    override fun updateNotification(scope: CoroutineScope, mediaSession: MediaSessionCompat) {
        scope.launch {
    ...
    override fun buildNotification(mediaSession: MediaSessionCompat): Notification {
        ...
        val clickIntent = PendingIntent.getActivity(context, 0, nowPlayingIntent, FLAG_MUTABLE)
    ...
    private fun getPreviousAction(context: Context): NotificationCompat.Action {
        ...
        val pendingIntent = PendingIntent.getService(context, 0, actionIntent,
